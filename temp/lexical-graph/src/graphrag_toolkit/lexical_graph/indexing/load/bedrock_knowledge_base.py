...
from ai4triage.lexical_graph.indexing import IdGenerator
from ai4triage.lexical_graph.indexing.load.file_based_chunks import FileBasedChunks
from ai4triage.lexical_graph.indexing.model import SourceDocument
from ai4triage.lexical_graph.indexing.extract.id_rewriter import IdRewriter
from ai4triage.lexical_graph.indexing.utils.hash_utils import get_hash
from ai4triage.lexical_graph import GraphRAGConfig
    ...
    def __init__(self, 
        ...
        Args:
            ...
            output_dir (str): Directory path to store processed output. Defaults to
                GraphRAGConfig.local_output_dir.
