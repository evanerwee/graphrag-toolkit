...
class DisaggregateResults(ProcessorBase):
    ...
    def __init__(self, args: ProcessorArgs, filter_config: FilterConfig):
        """Initializes the Processor class with provided arguments and filter
        configuration.
    ...
    def _process_results(
        ...
        """Processes and disaggregates search results based on individual
        topics and their highest statement scores.
        ...
        for search_result in search_results.results:
            for topic in search_result.topics:
                ...
                disaggregated_results.append(
                    SearchResult(
                        topics=[topic], source=search_result.source, score=score
                    )
                )
