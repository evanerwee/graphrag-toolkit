...
class TruncateStatements(ProcessorBase):
    """TruncateStatements is a processor for truncating the number of
    statements in topics contained within search results.
    ...
    def _process_results(
        ...
        """Processes search results by truncating the number of statements in
        each topic based on the specified maximum statements per topic.
        ...
        def truncate_statements(topic: Topic):
            """A processor that truncates the number of statements for each
            topic in a search result collection.
        ...
        def truncate_search_result(index: int, search_result: SearchResult):
            """A processor class for truncating statements within search
            results.
