...
class ClearScores(ProcessorBase):
    ...
    def __init__(self, args: ProcessorArgs, filter_config: FilterConfig):
        """Initializes the class with the provided arguments for processing and
        filter configuration. Ensures proper setup by invoking the parent class
        initializer.
    ...
    def _process_results(
        ...
        """Processes the given search results by applying a scoring operation
        through a specified callback function. This method clears the scores of
        all search results within the given collection, setting them to None.
