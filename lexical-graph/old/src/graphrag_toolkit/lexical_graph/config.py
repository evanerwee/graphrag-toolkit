...
class _GraphRAGConfig:
    ...
    def sts(self):
        """
        Provides a property `sts` that retrieves an STS client instance. The client
        is created if not already available, enabling retrieval of identity and partition info.

        Returns
        -------
        Any
            A client instance for interacting with AWS STS.
        """
