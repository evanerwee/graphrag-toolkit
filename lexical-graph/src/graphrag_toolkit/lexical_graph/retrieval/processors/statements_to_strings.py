...
class StatementsToStrings(ProcessorBase):
    ...
    def _process_results(
        ...
        """Processes search results by converting topic statements into strings
        ...
        def get_statement_string(s):
            """Processor that converts statement objects to their string
            representations based on a specified attribute.
        ...
        def statements_to_strings(topic: Topic):
            """Processes search results by converting statements in topics to
            ...
            """
            topic.statements = [
                get_statement_string(statement) for statement in topic.statements
            ]
            return topic

        def search_result_statements_to_strings(
            index: int, search_result: SearchResult
        ):
            """Processes search results by converting statements within each
            result into string representations. The transformation is applied
            to topics within a search result through the use of the method
            `_apply_to_topics`.
        ...
        return self._apply_to_search_results(
            search_results, search_result_statements_to_strings
        )
