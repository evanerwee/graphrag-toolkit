...
def search_string_from(value: str):
    """Removes specific patterns from a string, reduces extra spaces, and
...
def label_from(value: str):
    """Converts a given string into a formatted label by removing specific
    patterns and capitalizing words.
