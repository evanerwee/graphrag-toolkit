...
class BedrockPromptProvider(PromptProvider):
    ...
    def __init__(
        ...
        """
        Initializes a BedrockPromptProvider for loading prompts from AWS Bedrock Agent.
        This constructor sets up the provider with configuration, prompt ARNs, and optional prompt versions.

        Args:
            config: The configuration object providing AWS clients and region.
            system_prompt_arn: The ARN or short name of the system prompt in Bedrock Agent.
            user_prompt_arn: The ARN or short name of the user prompt in Bedrock Agent.
            system_prompt_version: The version of the system prompt (if applicable).
            user_prompt_version: The version of the user prompt (if applicable).

        Raises:
            ValueError: If system or user prompt ARNs are not provided.
            RuntimeError: If AWS account ID cannot be retrieved via STS.
        """
