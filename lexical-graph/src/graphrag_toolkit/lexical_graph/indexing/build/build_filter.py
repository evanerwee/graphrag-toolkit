...
def default_source_metadata_formatter(metadata: Dict[str, Any]) -> Dict[str, Any]:
    """Formats source metadata by converting date and datetime fields to ISO
    8601 format.
...
class BuildFilter():
    """Provides a filtering mechanism for processing topics, statements, and
    source metadata.
    ...
    def __init__(self,
        ...
        """Initializes the instance with optional filter functions and a
        metadata formatter.
    ...
    def ignore_topic(self, topic: str) -> bool:
        """Evaluates whether a given topic should be ignored based on a
        filtering function and logs the decision if the topic is ignored.
    ...
    def ignore_statement(self, statement: str) -> bool:
        """Determines if a statement should be ignored based on the statement
        filter function provided. This method evaluates the given statement
        through the filter function and logs debug information if the statement
        is ignored.
    ...
    def format_metadata(self, metadata: Dict[str, Any]) -> Dict[str, Any]:
        """Formats the provided metadata dictionary using a source metadata
        formatter function.
