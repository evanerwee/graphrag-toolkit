...
class GraphBuilder(BaseComponent):
    ...
    def _to_params(self, p:Dict):
        """Converts a given dictionary into a specific parameters structure
    ...
    def index_key(cls) -> str:
        """Defines an abstract class method to retrieve the index key
        associated with the implementing class. This method must be implemented
        by all subclasses to provide a unique identifier or key for indexing
        purposes.
