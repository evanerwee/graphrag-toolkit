...
from graphrag_toolkit.document_graph.pipeline.load.load_result import LoadResult
from graphrag_toolkit.document_graph.pipeline.load.transformers.transformation_plan import TransformationPlan
...
class LoadProvider(ABC):
    ...
    def _apply_transformations(self, extraction_result: ExtractionResult) -> ExtractionResult:
        ...
        """
        from graphrag_toolkit.document_graph.transformers.transformer_provider_factory import TransformerProviderFactory
        from graphrag_toolkit.document_graph.transformers.transformer_provider_config import TransformerProviderConfig
