...
from graphrag_toolkit.document_graph.schema.document_node import DocumentNode
from graphrag_toolkit.document_graph.schema.schema_inference_utils import SchemaInferenceEngine
from graphrag_toolkit.document_graph.schema.schema_io import SchemaWriter
    ...
    def extract(self, source: str, ingestors=None, **kwargs):
        ...
        if not etl_schema:
            ...
            if not factory_schema:
                ...
                if hasattr(self.aws_config, 'factory') and self.aws_config.factory:
                    from graphrag_toolkit.document_graph.factory.schema_artifact import SchemaArtifact
                    import json
